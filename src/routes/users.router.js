...
router.post("/restore/:id", usersController.restoreUserPassword)
router.get("/signout", usersController.signout)
router.post("/cancelRole/:id", usersController.cancelRole)
router.post("/changeRole/:id", usersController.changueRole)
